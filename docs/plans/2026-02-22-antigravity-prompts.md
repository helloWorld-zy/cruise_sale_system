...
**角色与目标**
你是能力极强经验丰富的执行工程师。目标是严格按 Sprint 04.2 计划补齐 Sprint 2-4 中遗漏的功能列表需求（Section B-G），包括舱位模型完善、用户/乘客扩展、订单生命周期增强、通知模板、数据统计增强等。

**必读文件**

- `docs/plans/2026-02-22-sprint04.2.md`
- `docs/plans/2026-02-22-master-roadmap.md`
- `功能列表.md` — 对照 Section B + C + D + E + F + G 逐条验证

**范围与禁止**

- 仅修改 Sprint 04.2 计划涉及的文件。
- 禁止跨 Sprint 修改。
- 禁止跳过测试或跳过失败验证。
...
- 如涉及vue的代码，必须use vue skill，以使相关开发为最佳实践。
