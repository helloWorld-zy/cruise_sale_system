...
type CabinType struct {
	...
	CategoryID   int64      `gorm:"index;not null" json:"category_id"` // 所属舱型大类 ID
	...
	Occupancy    int        `gorm:"default:2" json:"occupancy"`        // 默认入住人数
	...
	Intro        string     `gorm:"type:text" json:"intro"`            // 舱型简介
